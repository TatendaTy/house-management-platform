            ...
            <div className="paddings innerWidth flexCenter hero-container">
                ...
                <div className="flexColStart hero-left">
                    ...
                    <div className="flexColStart hero-des">
                        <span className="secondaryText">Discover a beautiful & comfortable Home with ease</span>
                        <span className="secondaryText">Just scroll, have a 'wow' moment and select the best!</span>
                    </div>
